...
public class AboutApi {
     ...
     */
    public RegistryAbout getVersion() throws ApiException {
        ApiResponse<RegistryAbout> resp = getVersionWithHttpInfo();
        return resp.getData();
    }
     ...
     * Get version
     * Gets the NiFi Registry version.
     * @return ApiResponse&lt;RegistryAbout&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RegistryAbout> getVersionWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getVersionValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<RegistryAbout>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call getVersionAsync(final ApiCallback<RegistryAbout> callback) throws ApiException {
